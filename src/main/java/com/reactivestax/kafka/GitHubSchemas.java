...
public class GitHubSchemas {
    ...
    // Schema names
    public static final String SCHEMA_KEY = "com.reactivestax.kafka.connect.IssueKey";
    public static final String SCHEMA_VALUE_ISSUE = "com.reactivestax.kafka.connect.IssueValue";
    public static final String SCHEMA_VALUE_USER = "com.reactivestax.kafka.connect.UserValue";
    public static final String SCHEMA_VALUE_PR = "com.reactivestax.kafka.connect.PrValue";
