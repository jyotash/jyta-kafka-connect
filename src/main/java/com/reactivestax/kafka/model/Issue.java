...
import static com.reactivestax.kafka.GitHubSchemas.*;
...
public class Issue {
    ...
    private String body;
    private User user;
    private List<com.reactivestax.kafka.model.Label> labels = null;
    private Assignee assignee;
    private Milestone milestone;
    private Boolean locked;
    private Integer comments;
    private com.reactivestax.kafka.model.PullRequest pullRequest;
    ...
    public Issue(Integer id, String url, String repositoryUrl, String labelsUrl, String commentsUrl, String eventsUrl, String htmlUrl, Integer number, String state, String title, String body, User user, List<com.reactivestax.kafka.model.Label> labels, Assignee assignee, Milestone milestone, Boolean locked, Integer comments, com.reactivestax.kafka.model.PullRequest pullRequest, Object closedAt, Instant createdAt, Instant updatedAt, List<Assignee> assignees) {
        super();
        this.id = id;
        this.url = url;
    ...
    public List<com.reactivestax.kafka.model.Label> getLabels() {
        return labels;
    }

    public void setLabels(List<com.reactivestax.kafka.model.Label> labels) {
        this.labels = labels;
    }

    public Issue withLabels(List<com.reactivestax.kafka.model.Label> labels) {
        this.labels = labels;
        return this;
    }
    ...
    public com.reactivestax.kafka.model.PullRequest getPullRequest() {
        return pullRequest;
    }

    public void setPullRequest(com.reactivestax.kafka.model.PullRequest pullRequest) {
        this.pullRequest = pullRequest;
    }

    public Issue withPullRequest(com.reactivestax.kafka.model.PullRequest pullRequest) {
        this.pullRequest = pullRequest;
        return this;
    }
    ...
    public static Issue fromJson(JSONObject jsonObject) {
        ...
        if (jsonObject.has(PR_FIELD)){
            com.reactivestax.kafka.model.PullRequest pullRequest = com.reactivestax.kafka.model.PullRequest.fromJson(jsonObject.getJSONObject(PR_FIELD));
